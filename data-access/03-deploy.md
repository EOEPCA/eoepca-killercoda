...
Now we deploy the core eoAPI services. Localcoda needs the chart's Metrics Server for STAC CPU autoscaling. The STAC Browser also needs the public tutorial URL:
