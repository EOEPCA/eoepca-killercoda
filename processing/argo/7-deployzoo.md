...
Zoo will then deploy, on-demand when a new processing request is received, an Argo Workflow, which will then deploy the application and execute the data processing job. 
 
