We have learned in this tutorial how to deploy a sample EOEPCA Processing Building Block, with a [OGC Process API](https://ogcapi.ogc.org/processes/) interface using CWL workflows, running on a Kubernetes cluster via the [Argo Workflows](https://argoproj.github.io/argo-workflows/) engine.
