...
The response includes the sample `echo` process. You can also explore the API in the [Swagger UI]({{TRAFFIC_HOST1_81}}/swagger-ui/oapip/) - within the tutorial environment you will need to change the URL to explore to the one exposed outside its container, `{{TRAFFIC_HOST1_81}}/ogc-api/api`.
