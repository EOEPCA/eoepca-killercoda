...
For the OGC Process API interface, different "execution engines" are available, allowing to submit data processing jobs to different backends. At the time, K8S jobs (via Calrissian) or HPC jobs (via [Toil](./toil)) are supported.
