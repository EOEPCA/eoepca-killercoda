We have learned in this tutorial how to deploy a sample EOEPCA Processing Building Block, with a [OpenEO API](https://api.openeo.org/) interface and a [Geotrellis](https://github.com/locationtech/geotrellis) engine!
