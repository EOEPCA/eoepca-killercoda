...
ZOO-Project runs in Kubernetes, while Toil submits the application jobs to HTCondor in the HPC environment. We will follow a request across both sides during the tutorial.
